...
class Lexer:
    ...
    def client(self, c_file='lexical_input.c', output_file='lex_output.txt'):
        """
        scan the c_file and write the token lists to the specific file
        :param c_file: the c programing language source code file,default "lexical_input.c"
...
if __name__ == "__main__":
    ...
    # Lexer().client(c_file='lexical_input.c', output_file='lex_output.txt')
