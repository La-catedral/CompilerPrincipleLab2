...
class Parser:
    ...
    def client(self, file_to_sparse='input/lexical_input.c',output_file='output/out.txt'):
...
if __name__ == '__main__':
    ...
    # Parser('input/my_grammar.txt').client(file_to_sparse='input/lexical_input.c',output_file='output/out.txt')
